...
const gridItems = [
  ...
  { desc: 'Send as a group with friends or individually', borderColor: '#52225e', textColor: '#52225e', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#f682a5]', title: 'Couple' },
  { desc: 'Send as a group with friends or individually', borderColor: '#574c23', textColor: '#574c23', colSpan: 'lg:col-span-2', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#fedf6f]', title: 'Groom & Bride' },
  ...
  { desc: 'Send as a group with friends or individually', borderColor: '#184363', textColor: '#184363', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#b8cedc]', title: 'Send Gift' },
];
...
const Page = () => {
  ...
  return (
    ...
    >
      {/* Fixed Menu */}
      <div className="fixed bottom-2 left-1/2 transform -translate-x-1/2 w-auto py-3 px-3 flex text-[0.5rem] sm:text-[0.6rem] tracking-tight rounded-full frosted-glass text-white hover:bg-opacity-40 font-bold transition-all duration-500 z-50">
        <div className="flex gap-2 items-center">
                {gridItems.map((item, index) => (
                <div
                    key={index}
                    className="shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] p-2 rounded-md hover:bg-slate-400 bg-[#3f3f3f30]"
                >
                    {item.title}
                </div>
                ))}
          ...
          <div className="grid h-full grid-cols-1 lg:grid-cols-10 grid-rows-auto lg:grid-rows-4 gap-6 p-0">
            {gridItems.map((item, index) => (
              <div
                ...
                ${item.colSpan} ${item.rowSpan} p-4 ${item.backgroundColor} flex flex-col justify-start rounded-xl shadow-[box-shadow: rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px;] border min-h-[200px]`}
                style={{
              ...
              >
                ...
                <div 
                    className="py-1 text-sm font-[500] tracking-tight"
                    style={{
                        color: item.textColor,
