...
const gridItems = [
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-6', rowSpan: 'lg:row-span-2', backgroundColor: 'bg-[#fff]', title: 'COUPLE' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-2', backgroundColor: 'bg-[#FFECEC]', title: 'EVENT' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-6', rowSpan: 'lg:row-span-2', backgroundColor: 'bg-[#fff]', title: 'BRIDE & GROOM' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#FFF', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#C7253E]', title: 'GALLERY' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#FFECEC]', title: 'EVENT' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#FFECEC]', title: 'SAVE THE DATE' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-6', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#fff]', title: 'SPECIAL GUEST' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#C7253E', colSpan: 'lg:col-span-10', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#FFECEC]', title: 'GUESTBOOK' },
];
