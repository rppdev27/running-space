...
const gridItems = [
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-6', rowSpan: 'lg:row-span-2', backgroundColor: 'bg-[#fff]', title: 'COUPLE' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-2', backgroundColor: 'bg-[#EAFAFF]', title: 'EVENT' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-6', rowSpan: 'lg:row-span-2', backgroundColor: 'bg-[#fff]', title: 'BRIDE & GROOM' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#FFF', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#172B47]', title: 'GALLERY' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#EAFAFF]', title: 'EVENT' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-4', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#EAFAFF]', title: 'Save The Date' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-6', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#fff]', title: 'SPECIAL GUEST' },
  { desc: 'Send as a group with friends or individually', borderColor: '#E1E1E1', textColor: '#123E62', colSpan: 'lg:col-span-10', rowSpan: 'lg:row-span-1', backgroundColor: 'bg-[#EAFAFF]', title: 'GUESTBOOK' },
];
...
const Page = () => {
  ...
  return (
    <div className='flex h-screen w-full p-4 flex-col sm:flex-row'
      style={{
    ...
    >
      ...
      <div className="sm:sticky sm:top-0 h-auto sm:h-full w-full relative sm:w-1/4 rounded-xl shadow-[box-shadow: rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px;] min-h-[200px] p-4 my-4 inline">
        ...
        <div className="text-3xl my-3 text-[#123E62]"
             style={{
                fontFamily: 'Parisienne'
            }}
        >
        ...
        <div className="text-6xl tracking-tight text-[#123E62] leading-10 my-2"
            style={{
                fontFamily: 'Lalezar'
            }}
        >
          ...
          <div className="grid h-full grid-cols-1 lg:grid-cols-10 grid-rows-auto lg:grid-rows-4 gap-6 p-0">
            {gridItems.map((item, index) => (
              ...
              >
                ...
                <div className='text-[#1b461e] text-4xl tracking-tight font-bold'
                    style={{
